...
class General(commands.Cog):
    def __init__(self, bot):
        ...
        self.auto_replies = {
            ...
            "?сайт": "Наш сайт - **https://www.tidalmc.net/**",
            ...
            "?харчок": "@pehtok",
            "?правило 9": "Все слышали про правило номер 9, но никто не видел его по-настоящему",
            "?правило9": "Все слышали про правило номер 9, но никто не видел его по-настоящему",
            "?rule 9": "Все слышали про правило номер 9, но никто не видел его по-настоящему",
            "?rule9": "Все слышали про правило номер 9, но никто не видел его по-настоящему"
